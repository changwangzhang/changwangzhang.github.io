...
# Representative Work
* We propose the DeepImageSearch (ICML'26, [paper](/files/2026-icml-deepimagesearch.pdf)), establish a benchmark for deep visual memory retrieval in intelligent agents, and present the ImageSeeker agent framework enhanced by dual memory and multimodal tools, which endows AI with genuine "visual memory exploration capabilities" and redefines the paradigm of deep image retrieval.
* We have developed OEmbedding, a Vision-Language Model (VLM)-native representational foundation model. By proposing an innovative data curriculum and training mechanism, we have significantly improved multimodal representation performance. OEmbedding-v1-7B has ranked 4th on the MMEB-v1 international image-text representation benchmark ([Data as of 20250911](/images/OEmbedding-v1-7B-MMEB-v1-4th.png)).
...
* C Deng, M Deng, J Wu, D Zeng, T Wang, Q Xie, J Huang, S Ma, **C Zhang**, Z Wang, J Wang, Y Zhu, Z Dou. DeepImageSearch: Benchmarking Multimodal Agents for Context-Aware Image Retrieval in Visual Histories. Forty-third International Conference on Machine Learning, 2026. **(ICML 2026) (CCF A) ([pdf](/files/2026-icml-deepimagesearch.pdf) code)**
* D Shi, J Cao, Q Chen, W Sun, W Li, H Lu, F Dong, T Qin, K Zhu, M Liu, Y Jiang, J Yang, G Zhang, J Liu, **C Zhang**, J Wang, W Zhou. TaskCraft: Automated Generation of Agentic Tasks. The Fourteenth International Conference on Learning Representations, 2026. **(ICLR 2026) (CCF A) ([pdf](/files/2026-iclr-taskcraft.pdf) code)**
* M Li, M Liu, Z Wu, X Lin, J Zhang, M Yan, Z Xie, **C Zhang**, C Wen, L Xu, S Shen, C Wang. Towards Motion Turing Test: Evaluating Human-Likeness in Humanoid Robots. Conference on Computer Vision and Pattern Recognition, 2026. **(CVPR 2026) (CCF A) (pdf code)**
* Y Cui, F Liu, Z Wang, **C Zhang**, J Wang, C Wang, J Chen. SpecTran: Spectral-Aware Transformer-based Adapter for LLM-Enhanced Sequential Recommendation. ACM SIGIR Conference on Research and Development in Information Retrieval, 2026. **(SIGIR 2026) (CCF A) (pdf code)**
* Y Zhang, Y Sun, D Shen, Z Xie, F Liu, **C Zhang**, X Liu, J Wang, H Xiong. Discrete Preference Learning for Personalized Multimodal Generation. ACM SIGIR Conference on Research and Development in Information Retrieval, 2026. **(SIGIR 2026) (CCF A) (pdf code)**
* B Wang, J Chen, F Liu, **C Zhang**, J Wang, C Jin, C Chen, C Wang. Does LLM Focus on the Right Words? Diagnosing Language Bias in LLM-based Recommenders. In Proceedings of the ACM Web Conference, 2026. **(WWW 2026) (CCF A) ([pdf](/files/2026-www-word.pdf) code)**.
* Y Cui, F Liu, J Chen, X Lou, **C Zhang**, J Wang, Y Sun, X Yang, C Wang. Field Matters: A Lightweight LLM-enhanced Method for CTR Prediction. In Proceedings of the ACM Web Conference, 2026. **(WWW 2026) (CCF A) ([pdf](/files/2026-www-field.pdf) code)**.
* Z Lu, W Jiang, T Wu, Z Wang, **C Zhang**, S Shen, M Cheng. Walking Further: Semantic-Aware Multimodal Gait Recognition Under Long-Range Conditions. Proceedings of the AAAI Conference on Artificial Intelligence, 2026. **(AAAI 2026) (CCF A) (pdf code)**
* B Wang, F Liu, **C Zhang**, J Chen, Y Wu, S Zhou, X Lou, J Wang, Y Feng, C Chen, C Wang. LLM4DSR: Leveraging Large Language Model for Denoising Sequential Recommendation. ACM Transactions on Information Systems, 2025. **(TOIS 2025) (CCF A) ([pdf](/files/2025-tois-llm4dsr.pdf) code)**
